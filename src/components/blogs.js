      ...
      <div className="blogs-content">
        <div className="blogs-text">
          <Carousel infiniteLoop={true} showThumbs={false}>
            <div>
              <a href="https://medium.com/@eric.sk.cheung/so-you-wanna-use-regex-do-ya-fc9d1e5aaf99" target="_blank" rel="noopener noreferrer" className="blog-link">
                VIEW MEDIUM BLOG
                <img src="images/blog-images/blog-regex.png" alt="regex medium blog" className="blog-slide"/>
              </a>
            </div>
            <div>
              <a href="https://medium.com/@eric.sk.cheung/dont-sleep-on-css-b8083b7bc276" target="_blank" rel="noopener noreferrer" className="blog-link">
                VIEW MEDIUM BLOG
                <img src="images/blog-images/blog-css.png" alt="css medium blog" className="blog-slide"/>
              </a>
            </div>
            <div>
              <a href="https://medium.com/@eric.sk.cheung/being-on-point-with-api-endpoints-a543d3f6333b" target="_blank" rel="noopener noreferrer" className="blog-link">
                VIEW MEDIUM BLOG
