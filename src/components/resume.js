        ...
        <div className="resume-text">
          ...
          <div className="resume-history">
            <div>
              ...
              <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}><p className="resume-text-sub"><strong>Assistant Manager, Brooklyn, NY, October 2018 - October 2019</strong></p></ScrollAnimation>
              <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}><p className="resume-text-desc"><Icon name="angle double right"/>Managed staff, EOD financials, inventory, pop-up events, and food prep at Sushi restaurant in downtown Brooklyn</p></ScrollAnimation>
            </div>
            
            <div>
              <ScrollAnimation animateIn="flipInX" animateOnce={true} delay={200}><h3>Banzai Phresh</h3></ScrollAnimation>
              <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}> <p className="resume-text-sub"><strong>Owner/Sole Proprietor, Honolulu, HI, December 2017 - June 2018</strong></p></ScrollAnimation>
              <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}><p className="resume-text-desc"><Icon name="angle double right"/>Managed and operated a 6-month pop-up restaurant in Ala Moana Mall, Hawaii.</p></ScrollAnimation>
            ...
            <div>
              <ScrollAnimation animateIn="flipInX" animateOnce={true} delay={200}><h3>Banzai Phresh</h3></ScrollAnimation>
              <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}><p className="resume-text-sub"><strong>Owner, Brooklyn, NY, April 2016 - September 2017</strong></p></ScrollAnimation>
              <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}><p className="resume-text-desc"><Icon name="angle double right"/>Managed and operated an outdoor food booth for two seasons at Smorgasburg Market, Brooklyn.</p></ScrollAnimation>
          ...
          <div className="resume-education">
            ...
            <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={200}><p className="resume-text-sub"><strong>February 2020 - May 2020</strong></p></ScrollAnimation>
