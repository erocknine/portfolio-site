  ...
  return (
    <div className={projectDoc === 'hies' ? `projects-document hies`: "projects-document"}>
      ...
      <div className="project-content">
        ...
        <div className={ projectDoc === 'hies' ? "project-portion":"project-portion closed" }>
          <p className="p-solo">Maintaining the HIES Inc. brand of environmental conservation and sustainability, the redesigned page includes vibrant blue & green colors with updated high-resolution images following nature themes, and trimmed text for brevity.</p>
        </div>
        ...
        <div className={ projectDoc === 'hies' ? "project-portion":"project-portion closed" }>
          <p className="p-solo">Without taking away any vital information, I scraped the page for key points and reorganized them into assorted categories, ultimately displaying them on individual tiles with images related to environment, nature, and Hawaii (their home office location), while following the established blue & green color palette.</p>
        </div>
