    ...
    <section className="projects-section">
      ...
      <div className="projects-content">
        <div className="panels">
          ...
          <Panel title={"Hangouts"} text={'Tired of being invited by friends to places that are too far for comfort? Hangouts allows friended users to conveniently schedule get-togethers with Yelp suggested restaurants in areas mutually close to all parties.'} tech={'React JS, Ruby Rails, PostgreSQL, Yelp API, Geolocation API, Leaflet API, React CSS Transition Group, Semantic UI'} images={hangouts}/>
