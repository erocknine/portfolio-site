  ...
  return (
    <section className="profile-section">
      ...
      <div id="profile" className="profile-text">
        ...
        <ScrollAnimation animateIn="flipInX" animateOnce={true} delay={200}><p className="text desc">I am constantly charmed by the complexities of programming and coding technologies, and amazed by what's been created before me. My goal for every project is to be visually appealing yet functional, creative yet intuitive.</p></ScrollAnimation> 
        ...
        <ScrollAnimation offset={25} animateIn="flipInX" animateOnce={true} delay={100}><p className="text"><Icon name="angle double right"/>Languages & Frameworks - React, Redux, Javascript, Ruby, Rails, NodeJS, Express</p></ScrollAnimation>
