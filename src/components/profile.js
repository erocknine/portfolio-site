    ...
    <section className="profile-section">
      ...
      <div id="profile" className="profile-text">
        ...
        <div className="profile-picture">
          <img
            className="eric-sk-cheung"
            src="./images/ericskc.jpg"
            alt="Eric Sai Kit Cheung headshot"
          />
        ...
        <p className="text desc">
          Building aesthetically pleasing projects and waking myself from
          endless coding frenzies have become a normal pastime. My work aims to
          be visually appealing yet functional, creative yet intuitive.
          Technology keeps progressing, and it's getting harder to keep up.
          Hopefully, I'll be able to explore a decent amount of it.
        </p>
        <p className="text desc">
          I travel, game, and try to indulge in as many different kinds of food
          as possible. An NYC native, but I've lived in Philadelphia,
          California, Hawaii, and Japan.
        </p>
        <p className="text desc">
          Just a glimpse of who I am, my instagram feed is often littered with
          British Shorthair cats and messy cheeseburgers. I’ve taught English in
          Japan, previously self-published a fiction novel, and have owned &
          operated a food business in Brooklyn and Hawaii.
        </p>
      </div>
      <div className="profile-technical-skills">
        ...
        <h4 className="text">Languages & Frameworks</h4>
        ...
        <h4 className="text">Databases</h4>
        ...
        <div className="profile-skills">
          ...
          <div className="profile-skill">
            <div className="profile-skill-icon-semantic">
              <svg
                width="256px"
                height="256px"
                viewBox="0 0 256 256"
